 ...
 */
{
  ...
  if( maxval < 256 )
    ...
    {
      char minval = 0; 
      char delta  = (char)((double)(maxval - minval) / ysize);
      if(delta < 1 )
	delta = 1;
    ...
    // generate a gradient with 2 bytes of color depth
    {
      ...
      unsigned short delta  = (unsigned short)((double)(maxval - minval) / ysize);
      if(delta < 1 )
	delta = 1;
      ...
      for ( int yy = 0; yy < ysize; yy++ )
	{
	  unsigned short int value  = (short int) (minval+ (unsigned short)(yy*delta));
